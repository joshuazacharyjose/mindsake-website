                ...
                <Container>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Card className="flex flex-col h-full border-primary/20">
                            ...
                            <div className="space-y-3 mb-8 text-sm text-gray-500 border-t border-gray-100 pt-4">
                        ...
                        {/* Workshop Custom Card 3 */}
                        <Card className="flex flex-col h-full border-gray-100 bg-gray-50/50">
                            <div className="mb-4">
                                <span className="px-3 py-1 bg-gray-200 text-gray-600 text-xs font-semibold rounded-full uppercase tracking-wide">
                                    Interest Check
                                </span>
                            </div>
                            <h3 className="text-2xl font-bold font-heading text-secondary mb-3">
                            ...
                            <div className="space-y-3 mb-8 text-sm text-gray-500 border-t border-gray-200 pt-4">
                                <div className="flex items-center gap-2">
